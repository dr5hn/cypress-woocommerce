...
const WP_ADMIN_LOGIN = '/wp-login.php';
const WP_ADMIN_DASHBOARD = '/wp-admin';
const WP_ADMIN_PLUGINS = '/wp-admin/plugins.php';
const WP_ADMIN_SETUP_WIZARD = '/wp-admin/admin.php?page=wc-setup';
const WP_ADMIN_ALL_ORDERS_VIEW = '/wp-admin/edit.php?post_type=shop_order';
const WP_ADMIN_NEW_COUPON = '/wp-admin/post-new.php?post_type=shop_coupon';
const WP_ADMIN_NEW_ORDER = '/wp-admin/post-new.php?post_type=shop_order';
const WP_ADMIN_NEW_PRODUCT = '/wp-admin/post-new.php?post_type=product';
const WP_ADMIN_WC_SETTINGS = '/wp-admin/admin.php?page=wc-settings&tab=';
const WP_ADMIN_PERMALINK_SETTINGS = '/wp-admin/options-permalink.php';

const SHOP_PAGE = '/shop';
const SHOP_PRODUCT_PAGE = '/?p=';
const SHOP_CART_PAGE = '/cart';
const SHOP_CHECKOUT_PAGE = '/checkout/';
const SHOP_MY_ACCOUNT_PAGE = '/my-account/';

const MY_ACCOUNT_ORDERS = '/my-account/orders';
const MY_ACCOUNT_DOWNLOADS = '/my-account/downloads';
const MY_ACCOUNT_ADDRESSES = '/my-account/edit-address';
const MY_ACCOUNT_ACCOUNT_DETAILS = '/my-account/edit-account';
...
const StoreOwnerFlow = {
	login: () => {
		...
		cy.get( '#user_login' ).clear().type( Cypress.env( 'users' ).admin.username );
		cy.get( '#user_pass' ).clear().type( Cypress.env( 'users' ).admin.password );
